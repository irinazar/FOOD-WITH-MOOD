...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert(
      ...
      [
        {
          body: "Отличный ресторан с испанскими блюдами и винами. Были много раз в Испании, есть с чем сравнивать. Теперь добавили.и неожиданно хороший выбор сортов испанского пива.",
          userId: 1,
          restaurantId: 1,
        },
        {
          body: "Хороший интерьер. Вежливые не замученные официанты. Взяли тапасы, черную паэлью, суп. Отличное качество. Паэлья вкусная как в Барсе. Рекомендую",
          userId: 3,
          restaurantId: 1,
        },
        {
          body: "Заскочили в день города , гуляли по Ордынке и открыли ну совершено случайно маленький уютный дворик , веранду и сам ресторан . Ну что сказать - восторг по всем трём позициям закусок , по сидру и атутентичному пиву , по чудесному Григорию , само обаяние , общение и даже испанский стиль) Уютно вкусно тепло и сама Испания рядом.То самом , когда смело говоришь - лучшее начало дня !))",
          userId: 2,
          restaurantId: 2,
        },
        {
          body: "Замечательная кухня , отличная подача и выбор блюд, вкуснейшие продукты. Веранда во дворе старинного особняка в жаркий летний Московский день скроет вас от толпы и жаркого солнца.",
          userId: 3,
          restaurantId: 2,
        },
        {
